...
public class SongController {
    ...
    @ResponseBody
    public Song createSong(@RequestParam("name") String name, @RequestParam("artist") String artist, @RequestParam("location") String location, @RequestParam("lyrics") String lyrics) {
        return songService
                .create(SongService
                        .CreateSongCommand
                        .builder()
