...
@Component
public class RiskOnBigTransactionAmount implements PaymentCreatedObserver {
    private static final BigDecimal MAX_TRANSACTION_AMOUNT = new BigDecimal(1000);
    private final PaymentService paymentService;
    private final PaymentMethodService paymentMethodService;
    public RiskOnBigTransactionAmount(PaymentCreatedObserversNotifier paymentCreatedObserversNotifier,
    ...
    public void onPaymentCreated(Long paymentId, Long userId) {
        ...
        if (current_payment.getAmount().compareTo(MAX_TRANSACTION_AMOUNT) >= 0) {
